...
dataset = gun("normalised2.json", transforms=transform)
    ...
    with torch.no_grad():
        ...
        for image, labels in testloader:
            ...
            if full_output:
                ...
                plt.imshow(torchvision.transforms.Compose([torchvision.transforms.Grayscale()])(image_example))
                plt.show()
...
MAXIMUM_CHECKPOINTFAIL_PATIENCE = 3
